...
for feature, coef in zip(features, coefficients):
    if feature == 'is_bottleneck':
        print(f"{feature}: {coef:.4f} - Being a bottleneck course (if True) is associated with a change of about {coef / 1000:.3f} in GPA.")
    elif feature == 'is_gateway':
        print(f"{feature}: {coef:.4f} - Being a gateway course (if True) is associated with a change of about {coef / 1000:.3f} in GPA.")
    else:
        print(f"{feature}: {coef:.4f} - A unit increase in '{feature}' is associated with a change of about {coef / 1000:.3f} in GPA.")
